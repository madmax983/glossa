...
fn print_help() {
    ...
    println!(
        "{:<25} {}",
        ".βοήθεια / .help", "Δεῖξαι τήνδε τὴν βοήθειαν (Show this help)"
    );
    println!("{:<25} {}", ".ἔξοδος / .exit", "Ἐξελθεῖν (Exit REPL)");
    println!(
        "{:<25} {}",
        ".καθαρός / .clear", "Καθαρίσαι τὸ περιβάλλον (Clear history)"
    );
    println!(
        "{:<25} {}",
        ".περιβάλλον / .env", "Δεῖξαι τὰς μεταβλητάς (Show variables)"
    );
