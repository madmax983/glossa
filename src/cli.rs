//! ΓΛΩΣΣΑ CLI Commands
//!
//! Implements the core logic for CLI commands like run, build, check, and highlight.
...
/// Compile a source string to Rust code
pub fn compile(source: &str) -> std::result::Result<String, GlossaError> {
...
pub fn cache_valid(input: &Path, cached_exe: &Path) -> bool {
...
pub fn check_file_size(input: &Path) -> Result<()> {
