...
pub fn analyze_article(word: &str) -> Option<DisambiguationContext> {
    ...
    let ctx = |case: Option<Case>, num: Number, gender_arg: Option<Gender>| {
        Some(DisambiguationContext {
            expected_case: case,
            expected_number: Some(num),
            expected_gender: gender_arg,
            expected_person: None,
        })
    };
    ...
    match word {
        ...
        "τῶν" | "των" => ctx(Some(Case::Genitive), Number::Plural, None), // All genders share τῶν
        "τοῖς" | "τοις" => {
            ctx(Some(Case::Dative), Number::Plural, Some(Gender::Masculine))
        }
        "τούς" | "τοὺς" | "τους" => ctx(
            Some(Case::Accusative),
            Number::Plural,
        ...
        "τῇ" | "τη" => ctx(Some(Case::Dative), Number::Singular, Some(Gender::Feminine)),
        "τήν" | "τὴν" | "την" => ctx(
            Some(Case::Accusative),
            Number::Singular,
            Some(Gender::Feminine),
        ...
        "ταῖς" | "ταις" => ctx(Some(Case::Dative), Number::Plural, Some(Gender::Feminine)),
        "τάς" | "τὰς" | "τας" => ctx(
            Some(Case::Accusative),
            Number::Plural,
            Some(Gender::Feminine),
        ...
        "τό" | "τὸ" | "το" => ctx(None, Number::Singular, Some(Gender::Neuter)),
        "τά" | "τὰ" | "τα" => ctx(None, Number::Plural, Some(Gender::Neuter)),
