...
pub struct Scope {
    ...
    traits: FxHashMap<String, crate::semantic::TraitDef>,
    /// Trait implementations in this scope
    trait_impls: Vec<crate::semantic::TraitImpl>,
...
impl Scope {
    ...
    pub fn define_trait(&mut self, name: String, trait_def: crate::semantic::TraitDef) {
        self.traits.insert(name, trait_def);
    }

    /// Look up a trait by name
    pub fn lookup_trait(&self, name: &str) -> Option<&crate::semantic::TraitDef> {
    ...
    pub fn register_trait_impl(&mut self, impl_def: crate::semantic::TraitImpl) {
    ...
    pub fn lookup_trait_impl(
        ...
        type_name: &str,
        trait_name: &str,
    ) -> Option<&crate::semantic::TraitImpl> {
