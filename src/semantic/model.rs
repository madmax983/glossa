//! Semantic Model for ΓΛΩΣΣΑ
//!
//! This module contains the Abstract Syntax Tree (AST) nodes for the semantic analysis phase.
//! It decouples the data structures from the analysis logic and type definitions.
...
// --- Types moved from src/semantic/types.rs ---
