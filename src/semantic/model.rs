//! Semantic Analysis Models (AST)
//!
//! This module defines the data structures produced by the semantic analysis phase.
//! It serves as the "Typed AST" for the compiler.
...
// ==================================================================================
// Trait Definition Structures (Moved from types.rs)
// ==================================================================================
