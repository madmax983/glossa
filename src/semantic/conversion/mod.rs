...
//!
//! 3. **Expression Fallback**: If no verb implies a statement, it is treated as a pure expression.
//!    - **Operations**: `1 + 2`.
...
pub(crate) use classification::classify_assembled_statement;
pub(crate) use extraction::extract_value;

use super::assembly::AssembledStatement;
use super::model::AnalyzedStatement;
