...
use crate::semantic::assembly::{AssembledStatement, Constituent};
use crate::semantic::conversion::extract::*;
...
pub(crate) fn resolve_binding_target<'a>(
    ...
    let has_false_participle = !asm_stmt.participles.is_empty()
        && lexicon::lookup(&asm_stmt.participles[0].verb_lemma).is_none();
