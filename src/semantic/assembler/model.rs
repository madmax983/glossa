//! Data models for the assembler
//!
//! Contains the core data structures used by the semantic assembler,
//! including assembled constituents, statements, and error types.
