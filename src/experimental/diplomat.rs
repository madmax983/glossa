...
//! (`εἶδος`) within a ΓΛΩΣΣΑ program and translates them into TypeScript `interface` declarations.
//!
//! # Purpose
//!
//! To bridge Ancient Greek backends with modern TypeScript frontends.
