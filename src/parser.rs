...
//! # The Parsing Flow
//!
//! 1. **Grammar (`src/grammar.pest`)**: Uses [`pest`] (PEG parser) to tokenize the input
...
// ==================================================================================
// RECURSION CHECK (formerly recursion.rs)
// ==================================================================================
...
fn parse_source(source: &str) -> Result<Program, ParseError> {
    ...
    let pairs = parse_pest(source).map_err(|e| ParseError::PestError(e.to_string()))?;
...
mod tests {
    ...
    #[test]
    fn test_parse_number_literal_pest() {
        let source = "42 λέγε.";
        let result = parse_pest(source);
    ...
    fn test_parse_greek_question_mark() {
        // Using Greek question mark (U+0374 or 037E) - looks like ; but is different
