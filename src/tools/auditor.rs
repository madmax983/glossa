...
fn visit_expr(
    ...
    match &expr.expr {
        ...
        AnalyzedExprKind::UnaryOp { operand, .. } => visit_expr(operand, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::StructInstantiation { args, .. } => visit_exprs(args, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::PropertyAccess { owner, .. } => visit_expr(owner, usage_count, mutation_count, mutable_vars),
        ...
        AnalyzedExprKind::FunctionCall { args, .. } => visit_exprs(args, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::VerbCall { args, .. } => visit_exprs(args, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::ArrayLiteral(exprs) => visit_exprs(exprs, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::IndexAccess { array, index } => {
            visit_expr(array, usage_count, mutation_count, mutable_vars);
            visit_expr(index, usage_count, mutation_count, mutable_vars);
        }
        AnalyzedExprKind::Lambda { body, .. } => visit_expr(body, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::Some(inner) => visit_expr(inner, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::Ok(inner) => visit_expr(inner, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::Err(inner) => visit_expr(inner, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::Unwrap(inner) => visit_expr(inner, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::Try(inner) => visit_expr(inner, usage_count, mutation_count, mutable_vars),
        AnalyzedExprKind::Assert { condition } => visit_expr(condition, usage_count, mutation_count, mutable_vars),
...
mod tests {
    ...
    fn test_auditor_visitor_coverage_expressions() {
        ...
        for kind in exprs {
            ...
            visit_expr(&expr, &mut usage_count, &mut mutation_count, &mut mutable_vars);
        }
    }
