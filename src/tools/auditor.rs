...
//! 2. The `visit_statement` and `visit_expr` functions traverse every statement and expression in the AST.
//! 3. They track variable declarations, usages, and reassignments using HashMaps and HashSets.
