...
//! 2. Pure functional recursion (`analyze_statement`) traverses every statement and expression in the AST.
//! 3. State variables track variable declarations, usages, and reassignments using HashMaps and HashSets.
...
/// Flattens the AST traversal into purely functional recursion, eliminating `AuditorVisitor`.
