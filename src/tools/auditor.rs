...
fn audit_expr(expr: &AnalyzedExpr, usage_count: &mut FxHashMap<SmolStr, usize>) {
    match &expr.expr {
        ...
        AnalyzedExprKind::Some(inner) => audit_expr(inner, usage_count),
        AnalyzedExprKind::Ok(inner) => audit_expr(inner, usage_count),
        AnalyzedExprKind::Err(inner) => audit_expr(inner, usage_count),
        AnalyzedExprKind::Unwrap(inner) => audit_expr(inner, usage_count),
