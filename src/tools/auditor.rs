...
//! 2. Recursive functions traverse every statement and expression in the AST.
//! 3. The functions track variable declarations, usages, and reassignments using HashMaps and HashSets.
