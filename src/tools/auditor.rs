...
//! 2. A recursive function (`visit_statement`) traverses every statement and expression in the AST.
//! 3. The traversal tracks variable declarations, usages, and reassignments using mutable HashMaps and HashSets.
