...
mod tests {
    ...
    #[test]
    fn test_run_mosaic_encoding_error() {
        // String::from_utf8 fails if the writer outputs invalid utf8
        // Our writer is generated by comfy_table, which always produces valid UTF-8.
        // It's impossible to force comfy-table to output invalid UTF-8.
        // So that branch is practically unreachable without mocking comfy-table.
    }
}
