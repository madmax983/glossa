...
pub fn run_haruspex(input: &Path) -> Result<()> {
    ...
    let dot = generator.generate_dot(&program);
...
impl DotGenerator {
    ...
    fn generate_dot(&mut self, program: &AnalyzedProgram) -> String {
