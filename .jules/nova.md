...
## The Commander (ὁ Στρατηγός)
**Concept:** A Bash transpiler (`glossa commander`) that converts analyzed Glossa programs directly to Bash scripts.
**Fate:** Proposed
**Lesson:** Proved that Glossa semantics can map to simple shell scripts.
