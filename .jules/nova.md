...
**Concept:** A CLI tool (`glossa astrolabe`) that recursively traverses the AnalyzedProgram AST and extracts all string literals into a table output, acting as a Localization/i18n string extractor.
**Fate:** Merged
**Lesson:** Iterating through nested Enums is a great way to extract assets quickly without needing serde.
