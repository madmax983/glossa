...
**Fate:** Merged
**Lesson:** Adding an exporter for another typed language (TypeScript) proves the flexibility of the compiler's semantic type system mapping (`GlossaType`). It allows seamless data interop between Ancient Greek semantics and modern web APIs.
