...
**Concept:** A CLI tool (`glossa sculptor`) that exports Glossa type definitions (`εἶδος`) into TypeScript interfaces.
**Fate:** Proposed
**Lesson:** Treating Glossa as a definition language allows us to easily bridge the gap to web frontends by generating structural TypeScript code for defined structs.
