...
**Concept:** A TypeScript interface generator (`glossa diplomat`) that transcribes Glossa type declarations (`εἶδος`) directly to TypeScript `.d.ts` interfaces.
**Fate:** Merged
**Lesson:** Building an exporter for the frontend proved how versatile and platform-agnostic the Glossa Semantic AST is. This adds a critical bridge for developers wanting to integrate ancient grammar directly with modern Web Development.
