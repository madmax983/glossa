...
**2025-02-20 - Unsoundness in anyhow**
**Threat:** anyhow < 1.0.104 had unsoundness in `Error::downcast_mut()` allowing memory corruption.
**Defense:** Updated `anyhow` to a secure version via `cargo update -p anyhow`.
