...
## [Reduction]
**Bloat:** The speculative tree-walk interpreter in `src/experimental`.
**Cut:** Deleted the `src/experimental` directory and its references.
**Saved:** 200+ lines of dead code / Cognitive load of maintaining speculative execution paths.
