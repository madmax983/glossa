...
**Saved:** Replaced a localized object-oriented abstraction with standard procedural Rust functions.
## [Reduction]
**Bloat:** Object-oriented `Visitor` pattern in `GnomonVisitor` and `AuditorVisitor`
**Cut:** Flattened objects into pure procedural functions
**Saved:** Eliminated stateful class structures in favor of clean local states
