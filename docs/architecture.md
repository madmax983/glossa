...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(gnomon, "The Gnomon", "src/tools/gnomon.rs", "Big-O complexity estimator via static loop analysis")
        Container(haruspex, "The Haruspex", "src/tools/haruspex.rs", "Graphviz AST visualizer")
