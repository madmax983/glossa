...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(cache, "[Internal] Cache", "src/tools/cache.rs", "Incremental compilation cache")
        ...
        Container(report, "[Internal] Reporter", "src/tools/report.rs", "Generates statistics and structured reports")
        ...
        Container(ui, "[Internal] The Stage", "src/tools/ui.rs", "Presentation Layer & UI Helpers")
...
C4Component
    ...
    Container_Boundary(semantic, "Semantic Analysis") {
        ...
        Component(assembly_model, "[Internal] Assembly Model", "src/semantic/assembly/model.rs", "Data Transfer Objects (DTOs)")
