...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(cache, "Cache", "src/tools/cache.rs", "Incremental compilation cache [Internal]")
        ...
        Container(report, "Reporter", "src/tools/report.rs", "Generates statistics and structured reports [Internal]")
        ...
        Container(ui, "The Stage", "src/tools/ui.rs", "Presentation Layer & UI Helpers [Internal]")
...
C4Component
    ...
    Container_Boundary(semantic, "Semantic Analysis") {
        ...
        Component(assembly_model, "Assembly Model", "src/semantic/assembly/model.rs", "Data Transfer Objects (DTOs) [Internal]")
