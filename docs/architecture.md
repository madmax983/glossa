...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(gnomon, "The Gnomon", "src/tools/gnomon.rs", "Estimates Big-O time complexity")
        Container(haruspex, "The Haruspex", "src/tools/haruspex.rs", "Exports AST to Graphviz DOT diagram")
        ...
        Container(scholar, "The Scholar", "src/tools/scholar.rs", "Generates API Documentation in Markdown")
