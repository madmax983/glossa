...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(haruspex, "Haruspex", "src/tools/haruspex.rs", "Generates Graphviz DOT representation of the AST")
        Container(gnomon, "Gnomon", "src/tools/gnomon.rs", "Estimates Big-O time complexity by analyzing loop depth")
        Container(scholar, "Scholar", "src/tools/scholar.rs", "Generates Markdown API documentation from the AST")
