...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(haruspex, "Haruspex", "src/tools/haruspex.rs", "Visualizes AST as GraphViz DOT graph")
        ...
        Container(scholar, "Scholar", "src/tools/scholar.rs", "API doc generator")
