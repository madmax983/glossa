...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(haruspex, "Haruspex", "src/tools/haruspex.rs", "Visualizes the semantic AST as a Graphviz DOT diagram")
        ...
        Container(scholar, "Scholar", "src/tools/scholar.rs", "Generates API documentation")
