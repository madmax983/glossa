...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(gnomon, "The Gnomon", "src/tools/gnomon.rs", "Estimates Big-O time complexity by statically analyzing loop depth")
        Container(haruspex, "The Haruspex", "src/tools/haruspex.rs", "Translates semantic AST into a DOT graph for Graphviz visualization")
        ...
        Container(scholar, "The Scholar", "src/tools/scholar.rs", "Generates Markdown API documentation from parsed programs")
