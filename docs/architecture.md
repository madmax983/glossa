...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(haruspex, "Haruspex", "src/tools/haruspex.rs", "Visualizes AST via Graphviz DOT")
        ...
        Container(scholar, "The Scholar", "src/tools/scholar.rs", "Generates API Documentation")
