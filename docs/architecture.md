...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(gnomon, "The Gnomon", "src/tools/gnomon.rs", "Big-O complexity estimator via loop depth analysis")
        Container(haruspex, "The Haruspex", "src/tools/haruspex.rs", "Translates semantic AST into Graphviz DOT format")
