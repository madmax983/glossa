...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(gnomon, "The Gnomon", "src/tools/gnomon.rs", "Estimates Big-O time complexity via AST loop depth")
        Container(haruspex, "The Haruspex", "src/tools/haruspex.rs", "Visualizes AST into Graphviz DOT")
        ...
        Container(scholar, "The Scholar", "src/tools/scholar.rs", "Generates Markdown API docs from AST")
