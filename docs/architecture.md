...
C4Container
    ...
    Container_Boundary(tools, "Developer Experience (Nova)") {
        ...
        Container(gnomon, "The Gnomon", "src/tools/gnomon.rs", "Estimates Big-O complexity")
        Container(haruspex, "The Haruspex", "src/tools/haruspex.rs", "Generates Graphviz DOT AST")
        ...
        Container(scholar, "The Scholar", "src/tools/scholar.rs", "Generates Markdown API docs")
