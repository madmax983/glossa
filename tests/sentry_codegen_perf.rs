//! Tests for code generation performance and safety limits.
//!
//! This module verifies that the Rust code generated by Glossa compiler does not
//! panic at runtime when it hits edge cases like out-of-bounds indexing, division by zero,
//! and negative numbers. It essentially tests the `Sentry` guarantees in the code generator.
