    ...
    fn test_filter_with_comparative() {
        ...
        if let Ok(analyzed) = analyzed {
            ...
            assert!(
                ...
                "Should have .filter() or .g_filter()"
            );
            assert!(
